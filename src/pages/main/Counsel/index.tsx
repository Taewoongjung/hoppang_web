        ...
        '서비스': [
            {
                ...
                answer: '"호빵"은 "호구 빵명"의 줄임말로, 누구나 샷시 견적을 쉽고 투명하게 받을 수 있도록 돕겠다는 의미를 담고 있어요. 복잡한 과정 없이 편하게 비교하고, 합리적인 선택을 하실 수 있도록 만든 서비스입니다.'
            },
            {
                question: '호빵은 어떤 서비스를 하고있나요?',
                answer: '샷시 견적 비교 서비스를 주로 제공하며, 견적 상담, 현장 측정, 시공 연결 등 샷시 교체의 전 과정을 지원합니다. 또한 샷시 관련 궁금증을 해결해드리는 지식인 서비스도 준비 중입니다.'
            }
        ],
        '시공': [
            {
