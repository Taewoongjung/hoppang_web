...
const ChassisPerformance = () => {
    ...
    return (
        <>
            <Helmet>
                <title>샷시 성능 비교 가이드 - 호빵</title>
                <meta name="description"
                      content="호빵이 알려주는 샷시 가격·성능 체크 포인트. 브랜드보다 중요한 유리와 옵션, 견적 비교 시 꼭 체크해야 할 사항을 확인하세요."/>

                <meta property="og:type" content="website"/>
                <meta property="og:title" content="샷시 성능 비교 가이드 - 호빵(호구빵명) 샷시"/>
                <meta property="og:description" content="호빵이 알려주는 샷시 가격·성능 체크 포인트. 브랜드보다 중요한 유리와 옵션, 견적 비교 시 꼭 체크해야 할 사항을 확인하세요."/>
            ...
            <div className="container">
                <div className="header">
                    ...
                    />
                    <button className="share-btn" onClick={() => handleShare('"샷시 성능 비교 가이드 - 호빵(호구빵명) 샷시"')}>
                ...
                <div className="content">
                    <div className="guide-section">
                        ...
                        <div className="section-content">
                            <div className="guide-item">
                                <p>
                                    샷시는 고급형을 쓴다고 해서 단열이나 방음이 체감될 만큼 좋아지지 않아요.
                                    <br/>
                    ...
                    <div className="guide-section">
                        <div className="section-header">
                            <h2>🪟 샷시는 기본형으로도 충분해요</h2>
                        </div>
                        <div className="section-content">
                            <div className="guide-item">
                                <p>
                                    샷시는 제일 기본형으로도 충분히 좋아요.<br/>
                        ...
                        <div className="section-content">
                            <div className="guide-item">
                                <ul>
                                    ...
                                    <li><strong>샷시가 기본형인지, 고급형인지</strong></li>
                                ...
                                >
                                    ...
                                    <span className="text-lg">내 집에 적용하면 얼마? 무료 견적 확인</span>
