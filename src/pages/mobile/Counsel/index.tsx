    ...
    const faqQAData: { [key: string]: { question: string; answer: string }[] } = {
        '견적': [
            ...
            },
            {
                ...
                answer: '네, 현재 현대샷시, LX샷시, KCC글라스 등 주요 브랜드의 견적을 비교해서 받아보실 수 있습니다. 동일한 조건으로 여러 업체 견적을 한 번에 확인하세요.'
            },
            {
        ...
        '서비스': [
            {
                ...
                answer: '호빵은 "좋은 창호를 빵처럼 쉽고 간편하게"라는 의미로 만들어진 브랜드명입니다. 복잡한 샷시 견적을 간단하고 투명하게 제공하는 것이 저희 목표입니다.'
            },
            {
                question: '호빵은 어떤 서비스를 하고있나요?',
                answer: '샷시 견적 비교 서비스를 주로 제공하며, 견적 상담, 현장 측정, 시공 연결 등 창호 교체의 전 과정을 지원합니다. 또한 샷시 관련 궁금증을 해결해드리는 지식인 서비스도 준비 중입니다.'
            }
        ],
        '시공': [
            {
            ...
            },
            {
                ...
                answer: '일반적으로 계약금(30%) → 중도금(30%) → 잔금(40%) 순으로 분할 결제가 가능합니다. 현금, 카드, 계좌이체 모두 지원하며, 세금계산서 발행도 가능합니다.'
            },
            {
        ...
        '계정': [
            {
                ...
                answer: '개인정보는 암호화하여 안전하게 보관하며, 견적 이력과 상담 내용은 마이페이지에서 언제든 확인하실 수 있습니다. 회원 탈퇴 시 모든 정보는 완전히 삭제됩니다.'
            }
        ],
        '기타': [
            {
                question: 'A/S는 어떻게 진행되고 있나요?',
                answer: '시공 완료 후 각 브랜드별 A/S 정책에 따라 지원됩니다. 일반적으로 1-10년의 보증기간이 제공되며, A/S가 필요한 경우 저희를 통해 연결해드립니다.'
            },
            {
                question: '제휴/협업 문의는 어떻게 하나요?',
                answer: '비즈니스 제휴나 협업은 카카오톡 채널 또는 고객센터를 통해 문의해주세요. 상세한 제안서와 함께 연락주시면 검토 후 답변드리겠습니다.'
            },
            {
                question: '이벤트/혜택 관련 알고싶습니다.',
                answer: '현재 진행 중인 이벤트와 할인 혜택은 메인 페이지와 견적 결과에서 확인하실 수 있습니다. 신규 이벤트 소식은 카카오톡 채널로 안내해드립니다.'
            }
        ]
    };
