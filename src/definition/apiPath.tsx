...
export const callMyBoardsPostsBookmarked = `https://hoppang.store/api/boards/posts/my/bookmarks`;
...
// export const callMyBoardsPostsBookmarked = `http://localhost:7070/api/boards/posts/my/bookmarks`;
