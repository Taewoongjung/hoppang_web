...
export const calculateSimpleChassisCall = `https://hoppang.store/api/customers/chassis/simple/calculations/prices`;
...
export const callSimpleEstimationSquareFeetType = `https://hoppang.store/api/customers/chassis/simple/calculations/squarefeet`;
